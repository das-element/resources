...
Script that gets run before dragging elements from the gallery view
The output of this script will be the dragged data in a JSON format
...
export default function main(items) {
  ...
  // iterate over selected and dragged items and run custom logic
  items.forEach((item) => {
    const path_main = item.path;
    result.push(path_main);
  });
